...
public class Staff {
    ...
    public Staff() {
        ...
        staffList[6] = new Commission("小刚","浦口","11111111111","123-45-6789",6.25,0.2);
        staffList[7] = new Commission("小兰","溧水","22222222222","987-65-4321",9.75,0.15);
